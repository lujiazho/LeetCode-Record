///////////////////////////////////////////////////////////////////////////////////////////////
// hard dp, but this tutorial is clear (from others)
////////////////
// Time Complexity: O(i*j*k*color_num)
// Space Complexity: O(i*j*k)
///////////////////////////////////////////////////////////////////////////////////////////////
class Solution {
public:
    // [i][j][k]: ith house, belonging to jth group, being colored as k
    // dp[i][j][k]: min cost of all houses after ith house(include) are painted
    int dp[100][100][21];
    ...
    int f(vector<int>& houses, vector<vector<int>>& cost, int target, int idx, int count, int prev){
        ...
        if(houses[idx]){
            ...
            // we have to try all the colors to paint the ith house
